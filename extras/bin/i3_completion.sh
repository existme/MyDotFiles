# i3 version: 4.14.1-180-g01603829
...
_i3-msg() 
{
	...
	# resize set <word> ppt <word> px
	if [[ $COMP_CWORD -gt 6 && ( ${COMP_WORDS[COMP_CWORD-1]} == "px" && ${COMP_WORDS[COMP_CWORD-3]} == "ppt" && ${COMP_WORDS[COMP_CWORD-5]} == "set" && ${COMP_WORDS[COMP_CWORD-6]} == "resize" ) ]] ; then
		return 0
	fi

	# resize set <word> ppt <word> ppt
	if [[ $COMP_CWORD -gt 6 && ( ${COMP_WORDS[COMP_CWORD-1]} == "ppt" && ${COMP_WORDS[COMP_CWORD-3]} == "ppt" && ${COMP_WORDS[COMP_CWORD-5]} == "set" && ${COMP_WORDS[COMP_CWORD-6]} == "resize" ) ]] ; then
		return 0
	fi
	...
	# resize set <word> ppt <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "ppt" && ${COMP_WORDS[COMP_CWORD-4]} == "set" && ${COMP_WORDS[COMP_CWORD-5]} == "resize" ) ]] ; then
		local opts="px ppt"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps inner current plus <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "plus" && ${COMP_WORDS[COMP_CWORD-3]} == "current" && ${COMP_WORDS[COMP_CWORD-4]} == "inner" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps inner current minus <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "minus" && ${COMP_WORDS[COMP_CWORD-3]} == "current" && ${COMP_WORDS[COMP_CWORD-4]} == "inner" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps inner current set <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "set" && ${COMP_WORDS[COMP_CWORD-3]} == "current" && ${COMP_WORDS[COMP_CWORD-4]} == "inner" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps inner all plus <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "plus" && ${COMP_WORDS[COMP_CWORD-3]} == "all" && ${COMP_WORDS[COMP_CWORD-4]} == "inner" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps inner all minus <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "minus" && ${COMP_WORDS[COMP_CWORD-3]} == "all" && ${COMP_WORDS[COMP_CWORD-4]} == "inner" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps inner all set <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "set" && ${COMP_WORDS[COMP_CWORD-3]} == "all" && ${COMP_WORDS[COMP_CWORD-4]} == "inner" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps outer current plus <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "plus" && ${COMP_WORDS[COMP_CWORD-3]} == "current" && ${COMP_WORDS[COMP_CWORD-4]} == "outer" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps outer current minus <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "minus" && ${COMP_WORDS[COMP_CWORD-3]} == "current" && ${COMP_WORDS[COMP_CWORD-4]} == "outer" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps outer current set <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "set" && ${COMP_WORDS[COMP_CWORD-3]} == "current" && ${COMP_WORDS[COMP_CWORD-4]} == "outer" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps outer all plus <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "plus" && ${COMP_WORDS[COMP_CWORD-3]} == "all" && ${COMP_WORDS[COMP_CWORD-4]} == "outer" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps outer all minus <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "minus" && ${COMP_WORDS[COMP_CWORD-3]} == "all" && ${COMP_WORDS[COMP_CWORD-4]} == "outer" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi

	# gaps outer all set <word>
	if [[ $COMP_CWORD -gt 5 && ( ${COMP_WORDS[COMP_CWORD-2]} == "set" && ${COMP_WORDS[COMP_CWORD-3]} == "all" && ${COMP_WORDS[COMP_CWORD-4]} == "outer" && ${COMP_WORDS[COMP_CWORD-5]} == "gaps" ) ]] ; then
		return 0
	fi
	...
	# resize set <word> ppt
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "ppt" && ${COMP_WORDS[COMP_CWORD-3]} == "set" && ${COMP_WORDS[COMP_CWORD-4]} == "resize" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps inner current plus
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "plus" && ${COMP_WORDS[COMP_CWORD-2]} == "current" && ${COMP_WORDS[COMP_CWORD-3]} == "inner" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "minus" && ${COMP_WORDS[COMP_CWORD-2]} == "current" && ${COMP_WORDS[COMP_CWORD-3]} == "inner" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi

	# gaps inner current set
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "set" && ${COMP_WORDS[COMP_CWORD-2]} == "current" && ${COMP_WORDS[COMP_CWORD-3]} == "inner" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps inner all plus
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "plus" && ${COMP_WORDS[COMP_CWORD-2]} == "all" && ${COMP_WORDS[COMP_CWORD-3]} == "inner" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi

	# gaps inner all minus
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "minus" && ${COMP_WORDS[COMP_CWORD-2]} == "all" && ${COMP_WORDS[COMP_CWORD-3]} == "inner" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps inner all set
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "set" && ${COMP_WORDS[COMP_CWORD-2]} == "all" && ${COMP_WORDS[COMP_CWORD-3]} == "inner" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi

	# gaps outer current plus
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "plus" && ${COMP_WORDS[COMP_CWORD-2]} == "current" && ${COMP_WORDS[COMP_CWORD-3]} == "outer" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi

	# gaps outer current minus
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "minus" && ${COMP_WORDS[COMP_CWORD-2]} == "current" && ${COMP_WORDS[COMP_CWORD-3]} == "outer" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi

	# gaps outer current set
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "set" && ${COMP_WORDS[COMP_CWORD-2]} == "current" && ${COMP_WORDS[COMP_CWORD-3]} == "outer" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps outer all plus
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "plus" && ${COMP_WORDS[COMP_CWORD-2]} == "all" && ${COMP_WORDS[COMP_CWORD-3]} == "outer" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi

	# gaps outer all minus
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "minus" && ${COMP_WORDS[COMP_CWORD-2]} == "all" && ${COMP_WORDS[COMP_CWORD-3]} == "outer" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps outer all set
	if [[ $COMP_CWORD -gt 4 && ( ${COMP_WORDS[COMP_CWORD-1]} == "set" && ${COMP_WORDS[COMP_CWORD-2]} == "all" && ${COMP_WORDS[COMP_CWORD-3]} == "outer" && ${COMP_WORDS[COMP_CWORD-4]} == "gaps" ) ]] ; then
		local opts="WORD"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps inner current
	if [[ $COMP_CWORD -gt 3 && ( ${COMP_WORDS[COMP_CWORD-1]} == "current" && ${COMP_WORDS[COMP_CWORD-2]} == "inner" && ${COMP_WORDS[COMP_CWORD-3]} == "gaps" ) ]] ; then
		local opts="plus minus set"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi

	# gaps inner all
	if [[ $COMP_CWORD -gt 3 && ( ${COMP_WORDS[COMP_CWORD-1]} == "all" && ${COMP_WORDS[COMP_CWORD-2]} == "inner" && ${COMP_WORDS[COMP_CWORD-3]} == "gaps" ) ]] ; then
		local opts="plus minus set"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps outer current
	if [[ $COMP_CWORD -gt 3 && ( ${COMP_WORDS[COMP_CWORD-1]} == "current" && ${COMP_WORDS[COMP_CWORD-2]} == "outer" && ${COMP_WORDS[COMP_CWORD-3]} == "gaps" ) ]] ; then
		local opts="plus minus set"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps outer all
	if [[ $COMP_CWORD -gt 3 && ( ${COMP_WORDS[COMP_CWORD-1]} == "all" && ${COMP_WORDS[COMP_CWORD-2]} == "outer" && ${COMP_WORDS[COMP_CWORD-3]} == "gaps" ) ]] ; then
		local opts="plus minus set"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps inner
	if [[ $COMP_CWORD -gt 2 && ( ${COMP_WORDS[COMP_CWORD-1]} == "inner" && ${COMP_WORDS[COMP_CWORD-2]} == "gaps" ) ]] ; then
		local opts="current all"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi

	# gaps outer
	if [[ $COMP_CWORD -gt 2 && ( ${COMP_WORDS[COMP_CWORD-1]} == "outer" && ${COMP_WORDS[COMP_CWORD-2]} == "gaps" ) ]] ; then
		local opts="current all"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	# gaps
	if [[ $COMP_CWORD -gt 1 && ( ${COMP_WORDS[COMP_CWORD-1]} == "gaps" ) ]] ; then
		local opts="inner outer"
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
	...
	if [[ $cur != -* && ($COMP_CWORD == 1 || ${COMP_WORDS[COMP_CWORD-1]} == "]" || ${COMP_WORDS[COMP_CWORD-2]} == "-t" || ${COMP_WORDS[COMP_CWORD-2]} == "-s") ]] ; then
		local opts="move exec exit restart reload shmlog debuglog border layout append_layout workspace focus kill open fullscreen sticky split floating mark unmark resize rename nop scratchpad swap title_format mode bar gaps ["
		COMPREPLY=( $(compgen -W "$opts" -- $cur) )
		return 0
	fi
